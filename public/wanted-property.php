...
<head>
  ...
  <link rel="stylesheet" href="css/wanted-property.css" />
</head>
...
<div class="catpop" id="catPop" aria-hidden="true">
  ...
  <div class="catpop-list" id="catPopList"></div>
    ...
    <section class="hero-card">
      <div class="hero-copy">
        ...
        <h1>Post Your Wanted Property</h1>
        <span>Tell us what you need - Sellers come to you</span>
        <button class="post-btn" type="button" id="postWantedBtn"><b>+</b> Post Wanted Ad</button>
      </div>
      <div class="hero-house" aria-hidden="true">
        <div class="house-base"></div>
        <div class="house-body"><i></i><i></i><i></i></div>
    ...
    <section class="stats-grid" aria-label="Wanted statistics">
      <article class="stat-card">
        <span class="stat-icon"><svg viewBox="0 0 24 24"><path d="M12 21.1 10.6 20C5.6 15.6 2.3 12.7 2.3 8.9 2.3 5.8 4.7 3.4 7.8 3.4c1.7 0 3.4.8 4.2 2.1.8-1.3 2.5-2.1 4.2-2.1 3.1 0 5.5 2.4 5.5 5.5 0 3.8-3.3 6.7-8.3 11.1L12 21.1Z"/></svg></span>
        <div><strong>3</strong><span>My Wanted</span></div>
      </article>
      <article class="stat-card">
        <span class="stat-icon"><svg viewBox="0 0 24 24"><path d="M4 4h16v12H8.7L4 20.7V4Zm2 2v9.9l1.9-1.9H18V6H6Zm3 3h6v2H9V9Zm0 3h4v2H9v-2Z"/></svg></span>
        <div><strong>19</strong><span>Responses</span></div>
      </article>
    ...
    <article class="wanted-ad-card">
      <div class="ad-main">
        <aside class="ad-side">
          <span class="ad-round"><svg viewBox="0 0 24 24"><path d="m12 3 9 8h-3v9h-5v-6h-2v6H6v-9H3l9-8Z"/></svg></span>
          <span class="days"><svg viewBox="0 0 24 24"><path d="M7 2h2v3h6V2h2v3h3v17H4V5h3V2Zm11 8H6v10h12V10Z"/></svg>10 day<br>ago</span>
        </aside>
        <div class="ad-info">
          <div class="ad-title-row">
            <h3>Looking For 3BR Singel Story House</h3>
            <span class="status">ACTIVE</span>
          </div>
          <div class="badges">
            <span class="urgent">⚡ URGENT</span>
            <span class="verified">● VERIFIED</span>
            <span class="need"><svg viewBox="0 0 24 24"><path d="M7 2h2v3h6V2h2v3h3v17H4V5h3V2Zm11 8H6v10h12V10Z"/></svg> Need Time 2024/05/20</span>
          </div>
          <p>For Sale - House - Single Story House</p>
          <p>Budget <b>Rs 55M - Rs 80M</b></p>
          <p class="location"><svg viewBox="0 0 24 24"><path d="M12 2.5a7 7 0 0 0-7 7c0 5.2 7 12 7 12s7-6.8 7-12a7 7 0 0 0-7-7Zm0 9.5a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5Z"/></svg>Colombo - 5 (Rajagiriya/Rawathawatta Town...)</p>
          <p class="km">5KM Around</p>
        </div>
      </div>
      <div class="ad-actions">
        <button type="button"><svg viewBox="0 0 24 24"><path d="M12 5c5 0 9 5 10 7-1 2-5 7-10 7S3 14 2 12c1-2 5-7 10-7Zm0 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-2.1a1.9 1.9 0 1 1 0-3.8 1.9 1.9 0 0 1 0 3.8Z"/></svg>145</button>
        <button type="button">Responses <svg viewBox="0 0 24 24"><path d="M4 4h16v12H8.7L4 20.7V4Z"/></svg>5</button>
        <button type="button"><svg viewBox="0 0 24 24"><path d="M4 17.2V20h2.8L17.1 9.7l-2.8-2.8L4 17.2Zm15.3-9.7c.4-.4.4-1 0-1.4l-1.4-1.4a1 1 0 0 0-1.4 0l-1.1 1.1 2.8 2.8 1.1-1.1Z"/></svg>Edit</button>
        <button type="button" aria-label="Delete"><svg viewBox="0 0 24 24"><path d="M6 19c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V7H6v12ZM8 4l1-1h6l1 1h4v2H4V4h4Z"/></svg></button>
        <button type="button">Share <img src="img/icons/share.svg" class="share-img" alt=""></button>
      </div>
    </article>

    <section class="section-head responses-title">
      <h2>Responses</h2>
      <a href="#">View All <svg viewBox="0 0 24 24"><path d="m9.2 4.2 7.8 7.8-7.8 7.8-1.8-1.8 6-6-6-6 1.8-1.8Z"/></svg></a>
    </section>
  ...
  <div class="w post-card-sketch">
    ...
    <article class="message-card">
        <span class="message-icon"><svg viewBox="0 0 24 24"><path d="M4 4h16v12H8.7L4 20.7V4Zm2 2v9.9l1.9-1.9H18V6H6Zm3 3h6v2H9V9Zm0 3h4v2H9v-2Z"/></svg></span>
        <div class="message-count"><strong>5</strong><span>Messages</span></div>
      </article>
  </main>
